...
$query= mysql_query("insert into std_bank(enrollment_no,bank_name,bank_branch,bank_acc,acc_holder,aadhar_no)values('$enrollment_no','$bank_name','$bank_branch','$bank_acc','$acc_holder','$aadhar_no')");
  if ($query){
