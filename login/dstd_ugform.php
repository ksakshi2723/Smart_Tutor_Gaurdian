 ...
 if(isset($_REQUEST["submit"]))
{
  ...
  $query= mysql_query("insert into std_ug(enrollment_no,course,roll_no,rank,board,year_of_passing,total_mark,obtain_mark,percent)values('$user','$course','$roll_no','$rank','$board','$year_of_passing','$total_mark','$obtain_mark','$percent')");
if ($query){
 
     $_SESSION["user"]=$user;
     header('location:dug.php');
   }
   else{
      echo "not succes";
   }
