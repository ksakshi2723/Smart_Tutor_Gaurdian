...
$query= mysql_query("insert into studentadmission(enrollment_no,entrance,admissionbase,school_no,branch,semester)values('$user','$entrance','$admissionbase','$school_no','$branch','$semester')");
 if ($query){
    $_SESSION["user"]=$user;
