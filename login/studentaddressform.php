 ...
 if(isset($_REQUEST["submit"]))
{
  ...
  $query= mysql_query("insert into studentaddress(enrollment_no,house_no,street,state,city,district,country,pincode)values('$enrollment_no','$house_no','$street','$state','$city','$district','$country','$pincode')");
 if ($query)
 {
