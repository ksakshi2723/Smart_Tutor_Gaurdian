 ...
 if(isset($_REQUEST["submit"]))
{
  ...
  $query= mysql_query("insert into std_twelth(enrollment_no,course,roll_no,rank,board,year_of_passing,total_mark,obtain_mark,percent)values('$enrollment_no','$course','$roll_no','$rank','$board','$year_of_passing','$total_mark','$obtain_mark','$percent')");
 if ($query){
