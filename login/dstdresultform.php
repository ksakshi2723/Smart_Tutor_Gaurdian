...
move_uploaded_file($tmp_name, $path);
  ...
  $query=mysql_query("insert into result(enrollment,semester,result,sgpa,cgpa,back,file)values('$enrollment_no','$semester','$result','$sgpa','$cgpa','$back','$file')");
 if ($query)
 {
...
<div class="container">
  <form method="post" action="dstdresultform.php" enctype="multipart/form-data">
