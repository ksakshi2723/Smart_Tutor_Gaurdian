...
if(isset($_REQUEST["submit"]))
{
  ...
  $query= mysql_query("insert into  tgcalling(enrollment_no,semester,date,contact_no,reason_of_calling,discription,faculty_name)values('$user','$semester','$date','$contact_no','$reason_of_calling','$discription','$faculty_name')");
 if ($query)
 {
     $_SESSION["user"]=$user;
