 ...
 if(isset($_REQUEST["submit"]))
{
  ...
  $query= mysql_query("insert into studentresident(enrollment_no,house_no,street,state,city,district,country,pincode)values('$user','$house_no','$street','$state','$city','$district','$country','$pincode')");
 if ($query){
    echo "dresident.php";
   }
   else{
