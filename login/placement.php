...
<td>enrollment_no</td>
   ...
   <td>company_name</td>
   <td>placement_result</td>
   <td>joining_date</td>
   <td>placement_package</td>
   <td>placement_remark</td>
...
<tr>
  ...
  <td><?php echo $row["tnp_date"]?></td>
   <td><?php echo $row["placement_date"]?></td>
   <td><?php echo $row["company_name"]?></td>
   <td><?php echo $row["placement_result"]?></td>
   <td><?php echo $row["joining_date"]?></td>
   <td><?php echo $row["placement_package"]?></td>
